...
export default function DashboardLayout({
    ...
    <div className="bg-white">
        <button
            ...
            type="button"
            className="fixed top-0 left-0 z-40 ml-2 p-2 mt-2 sm:hidden inline-flex items-center text-white rounded-lg border border-cyan-400 bg-cyan-400"
        >
        ...
        <div
            ...
            className={`${
              ...
              } sm:block fixed top-0 left-0 z-40 w-64 h-screen transition-transform`}
        >
