...
export default function DashboardLayout({
    ...
    <div className="bg-white">
        <button
            ...
            type="button"
            className="md:hidden inline-flex items-center p-2 mt-2 ms-3text-sm text-gray-500 rounded-lg border border-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            >
        ...
        <div
            ...
            className={`${
              ...
              } md:block fixed top-0 left-0 z-40 w-64 h-screen transition-transform`}
        >
