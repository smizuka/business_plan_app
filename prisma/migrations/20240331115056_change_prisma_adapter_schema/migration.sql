...
-- DropForeignKey
ALTER TABLE "Questionary" DROP CONSTRAINT "Questionary_userId_fkey";
...
-- AlterTable
ALTER TABLE "Questionary" ALTER COLUMN "userId" SET DATA TYPE TEXT;
...
-- AddForeignKey
ALTER TABLE "Questionary" ADD CONSTRAINT "Questionary_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
